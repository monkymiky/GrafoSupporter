...
public class DatabaseInitializer {
    ...
    @Autowired
    public DatabaseInitializer(BookRepository bookRepository, SignRepository signRepository, SignCombinationRepository signCombinationRepository) {
    ...
    public void initBookDatabase() {
        if (bookRepository.count() == 0) {
            ...
            books.add(new Book(null, "Manuale di grafologia", "Girolamo Moretti", 1914, "Edizioni Messaggero Padova", "9788825010008"));
            books.add(new Book(null, "Vizio. Psicologia e grafologia dei sette vizi capitali", "Girolamo Moretti", 1937, "Edizioni Messaggero Padova", "9788825010015"));
            books.add(new Book(null, "Trattato scientifico di perizie grafiche su base grafologica", "Girolamo Moretti", 1942, "Edizioni Messaggero Padova", "9788825010251"));
            books.add(new Book(null, "Grafologia somatica. Il corpo umano dalla scrittura", "Girolamo Moretti", 1945, "Edizioni Messaggero Padova", "9788825010022"));
            books.add(new Book(null, "Grafologia pedagogica", "Girolamo Moretti", 1947, "Edizioni Messaggero Padova", "9788825010268"));
            books.add(new Book(null, "Grafologia delle attitudini umane", "Girolamo Moretti", 1948, "Edizioni Messaggero Padova", "9788825010039"));
            books.add(new Book(null, "I santi dalla scrittura", "Girolamo Moretti", 1952, "Edizioni San Paolo", "9788821535727"));
            books.add(new Book(null, "Trattato di grafologia. Intelligenza, sentimento", "Girolamo Moretti", 1955, "Edizioni Messaggero Padova", "9788825010800"));
            books.add(new Book(null, "Scompensi, anomalie della psiche e grafologia", "Girolamo Moretti", 1962, "Edizioni Messaggero Padova", "9788825010046"));
            books.add(new Book(null, "La passione predominante. Grafologia differenziale", "Girolamo Moretti", 1962, "Edizioni Messaggero Padova", "9788825010053"));
            books.add(new Book(null, "Analisi grafologiche", "Girolamo Moretti", 1966, "Edizioni Messaggero Padova", "9788825010060"));
            books.add(new Book(null, "I grandi dalla scrittura", "Girolamo Moretti", 1966, "Edizioni Messaggero Padova", "9788825010077"));
            books.add(new Book(null, "Grafologia e pedagogia nella scuola dell'obbligo", "Girolamo Moretti", 1970, "Edizioni Messaggero Padova", "9788825010084"));
            books.add(new Book(null, "Chi lo avrebbe mai pensato. Autobiografia", "Girolamo Moretti", 1977, "Edizioni Messaggero Padova", "9788825010091"));
        ...
        if (signRepository.count() == 0) {
            ...
            signs.stream().forEach(sign -> signRepository.save(sign));
        ...
        if (signCombinationRepository.count() == 0) {
            ...
            // signsToProcess.put("Intozzata I modo", 7); //aggiungi altri segni qui se sono più di 2 nella combinazione
            ...
            //     }else{
            //         System.err.println("ATTENZIONE: Segno con nome '" + signName + "' non trovato nel database. Impossibile creare ValuatedSign per la combinazione" + combinationTitle);
            //     }
            // });
        ...
        processSigns(combinationTitle, signsForDb, signsToProcess);
        Book book1 = processBook((long)8, combinationTitle);
        combinations.add(new SignCombination(null, combinationTitle, "Forte autostima, tendenza a imporsi", "Combinazione di autoaffermazione e tenuta.", signsForDb, book1));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Abilità nel trattare con gli altri, tatto", "Capacità di gestire situazioni complesse con astuzia e adattabilità.", signsForDb, book2));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Perseveranza, costanza negli obiettivi", "Forte determinazione e resistenza alla fatica e agli ostacoli.", signsForDb, book3));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Disponibilità immediata, slancio altruistico", "Tendenza a dare senza troppa riflessione, con calore.", signsForDb, book4));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Tendenza all'interiorizzazione e alla riflessione", "Preferenza per la contemplazione e l'analisi interiore.", signsForDb, book5));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Forte spinta al successo, con chiarezza di obiettivi", "Desiderio di realizzazione supportato da energia e decisione.", signsForDb, book6));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Capacità di analisi penetrante, giudizio tagliente", "Tendenza a esaminare a fondo e a non lasciarsi ingannare.", signsForDb, book7));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Capacità di adeguarsi a nuove situazioni", "Apertura al cambiamento e facilità di interazione.", signsForDb, book8));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Bisogno di agire rapidamente, poca tolleranza per l'attesa", "Energia focalizzata sull'azione immediata.", signsForDb, book9));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Eccessiva cautela, timore di sbagliare", "Rallentamento dell'azione dovuto a continua valutazione dei rischi.", signsForDb, book10));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Pensiero innovativo, inventiva", "Capacità di trovare soluzioni nuove e non convenzionali.", signsForDb, book11));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Mancanza di organizzazione nella quotidianità", "Tendenza alla trascuratezza e poca cura dei dettagli pratici.", signsForDb, book12));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Facilità ad essere feriti emotivamente", "Grande recettività emotiva che può portare a fragilità.", signsForDb, book13));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Grande attenzione ai dettagli, metodo rigoroso", "Ricerca della perfezione e dell'ordine.", signsForDb, book14)); // Grafologia Pedagogica
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Stato di nervosismo e irrequietezza", "Difficoltà a trovare calma e stabilità emotiva.", signsForDb, book15));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Forte adesione a ideali elevati, con trasporto emotivo", "Spinta da nobili cause e aspirazioni.", signsForDb, book16)); // I santi dalla scrittura
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Atteggiamento riservato e protettivo", "Diffidenza e tendenza a celare i propri pensieri ed emozioni.", signsForDb, book17));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Energia e iniziativa nel perseguire obiettivi", "Proattività e capacità di traino.", signsForDb, book18));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Adesione stretta alle regole e alle forme", "Scarsa flessibilità e spontaneità.", signsForDb, book19)); // Trattato scientifico di perizie grafiche
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Facilità di parola, apertura agli altri", "Bisogno di socializzare e condividere.", signsForDb, book20));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Capacità di cogliere dettagli sottili", "Sguardo penetrante e analitico.", signsForDb, book21));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Scarsa determinazione, facile suggestionabilità", "Difficoltà a mantenere gli impegni e a resistere alle pressioni.", signsForDb, book22));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Tendenza a non aprirsi, mantenendo un'alta stima di sé", "Freddezza apparente dovuta a orgoglio e controllo.", signsForDb, book23)); // Vizio (Superbia)
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Facilità a innervosirsi, reattività", "Suscettibilità e risposte umorali.", signsForDb, book24));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Caparbietà, difficoltà a cambiare idea", "Fermezza che può sfociare in testardaggine.", signsForDb, book25));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Mancanza di profondità, leggerezza eccessiva", "Tendenza a fermarsi all'apparenza.", signsForDb, book26));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Abilità nel piacere e attrarre con strategia", "Comportamento affascinante ma non del tutto spontaneo.", signsForDb, book27)); // La passione predominante
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Irrequietezza che alimenta la creatività", "Bisogno di esplorare e creare spinto da una tensione interna.", signsForDb, book28));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Difficoltà a scegliere accompagnata da ansia", "Blocco decisionale dovuto a timori e incertezze.", signsForDb, book29));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Visione concreta della realtà, senso pratico", "Piedi per terra, orientamento alla soluzione.", signsForDb, book30));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Forte intensità emotiva gestita con autocontrollo", "Sentimenti profondi ma non manifestati impulsivamente.", signsForDb, book31));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Tendenza a dubitare degli altri, diffidenza", "Atteggiamento guardingo e poco fiducioso.", signsForDb, book32));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Generosità non ostentata, aiuto silenzioso", "Disponibilità verso gli altri con umiltà e riservatezza.", signsForDb, book33));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Eccessiva meticolosità, pignoleria", "Attenzione esagerata ai dettagli formali.", signsForDb, book34));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Tendenza a comandare in modo direttivo", "Capacità di guida con forte imposizione della propria volontà.", signsForDb, book35));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Estrema calma, lentezza, imperturbabilità", "Scarsa reattività agli stimoli esterni.", signsForDb, book36));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Eccessiva cura della propria immagine e apparenza", "Ricerca di ammirazione per l'aspetto esteriore.", signsForDb, book37)); // Vizio
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Tendenza aggressiva non manifesta ma pronta a emergere", "Impulsi ostili controllati ma presenti.", signsForDb, book38));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Destrezza e precisione nei lavori manuali", "Buona coordinazione e attenzione ai dettagli pratici.", signsForDb, book39)); // Grafologia somatica
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Stato d'animo triste e pessimista", "Tendenza alla tristezza e alla riflessione nostalgica.", signsForDb, book40));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Capacità di parlare in modo fluente e convincente", "Abilità nell'influenzare gli altri con le parole.", signsForDb, book41));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Ostinazione derivante da un forte orgoglio", "Difficoltà ad ammettere errori o cedere posizioni.", signsForDb, book42));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Bisogno costante di conferme e lodi esterne", "L'autostima dipende molto dal giudizio altrui.", signsForDb, book43));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Difficoltà ad accettare norme e costrizioni", "Tendenza a sfidare l'autorità e le convenzioni.", signsForDb, book44));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Grande attenzione ai principi etici e morali", "Senso del dovere e della giustizia molto sviluppato.", signsForDb, book45));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Passione e vivacità che ispirano gli altri", "Capacità di trasmettere energia positiva e coinvolgimento.", signsForDb, book46));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Riservatezza eccessiva, tendenza a isolarsi", "Difficoltà nelle interazioni sociali per insicurezza.", signsForDb, book47));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Prevalenza della logica sulle emozioni, distacco", "Approccio analitico e impersonale alla realtà.", signsForDb, book48));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Tendenza a discutere e contraddire", "Piacere nella disputa e nella critica.", signsForDb, book49));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Desiderio di conoscere e apprendere", "Interesse vivace per vari campi del sapere.", signsForDb, book50));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Capacità di attendere con perseveranza e metodo", "Costanza nel lavoro verso un obiettivo a lungo termine.", signsForDb, book51));
        ...
        combinations.add(new SignCombination(null, combinationTitle, "Gusto per il bello, cultura e distinzione", "Ricercatezza nelle maniere e negli interessi.", signsForDb, book52)); // Grafologia delle attitudini umane
            combinations.stream().forEach(combination -> signCombinationRepository.save(combination));
    ...
    private void processSigns(String combinationTitle, ArrayList<ValuatedSign> signsForDb, HashMap<String, Integer> signsToProcess) {
        signsToProcess.entrySet().stream().forEach(sign -> {
            String signName = sign.getKey();
            Integer value = sign.getValue();
    ...
    private Book processBook(Long id, String combinationTitle){
        ...
        if(book.isPresent()){
            ...
            System.err.println("ATTENZIONE: Libro con id '" + id + "' non trovato nel database. Impossibile creare la combinazione :" + combinationTitle); 
        }
        return null;
    }
